...
import com.github.benmanes.caffeine.cache.simulator.policy.sampled.WeightedSampledPolicy;
...
public final class Registry {
    ...
    private static void registerSampled(Map<String, Function<Config, Set<Policy>>> factories) {
        ...
        Stream.of(WeightedSampledPolicy.EvictionPolicy.values()).forEach(priority -> {
            String id = "weighted_sampled." + priority.name();
            factories.put(id, config -> WeightedSampledPolicy.policies(config, priority));
        });
    }
